...
namespace PortSIP
{
    unsafe class PortSIP_NativeMethods
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public unsafe delegate Int32 inviteFailure(Int32 sessionId, String reason, Int32 code, StringBuilder sipMessage);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public unsafe delegate Int32 playAudioFileFinished(Int32 sessionId, String fileName);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public unsafe delegate Int32 playVideoFileFinished(Int32 sessionId);
