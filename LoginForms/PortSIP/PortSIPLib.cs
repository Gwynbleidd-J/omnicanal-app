...
namespace PortSIP
{
    unsafe class PortSIPLib
    {
        ...
        private void setCallbackHandlers()
        {
            ...
            PortSIP_NativeMethods.PSCallback_setPlayAudioFileFinishedHandler(_callbackDispatcher, _paf);
            PortSIP_NativeMethods.PSCallback_setPlayVideoFileFinishedHandler(_callbackDispatcher, _pvf);
 ...
 which will demonstrate the transfer.
       ...
       */
        ...
        */
        ...
        private unsafe Int32 onInviteFailure(Int32 sessionId, String reason, Int32 code, StringBuilder sipMessage)
        {
            return _SIPCallbackEvents.onInviteFailure(sessionId, reason, code, sipMessage);
        }
        ...
        private unsafe Int32 onPlayAudioFileFinished(Int32 sessionId, String fileName)
        {
            return _SIPCallbackEvents.onPlayAudioFileFinished(sessionId, fileName);
        }

        private unsafe Int32 onPlayVideoFileFinished(Int32 sessionId)
        {
            return _SIPCallbackEvents.onPlayVideoFileFinished(sessionId);
        }
