/*!
 * @author Copyright (c) 2008-2021 PortSIP Solutions,Inc. All rights reserved.
 * @version 18
...
namespace PortSIP
{
    ...
    */
    interface SIPCallbackEvents
    {
         ...
         *  @param sipMessage        The SIP message received.         
         */
        Int32 onInviteIncoming(Int32 sessionId,
         ...
         *  @param sipMessage       The SIP message received.   
         */
        Int32 onInviteSessionProgress(Int32 sessionId,
                                             String audioCodecNames,
                                             String videoCodecNames,
         ...
         *  @param sipMessage The SIP message received. 
         */
        Int32 onInviteRinging(Int32 sessionId,
                                            String statusText,
                                            Int32 statusCode,
                                            StringBuilder sipMessage);
         ...
         *  @param sipMessage           The SIP message received. 
         */
        Int32 onInviteAnswered(Int32 sessionId,
                                             String callerDisplayName,
                                             String caller,
                                             String calleeDisplayName,
                                             String callee,
         ...
         *  @param sipMessage The SIP message received. 
         */
        Int32 onInviteFailure(Int32 sessionId, String reason, Int32 code, StringBuilder sipMessage);
         ...
         *  @param sipMessage  The SIP message received. 
         */
        Int32 onInviteUpdated(Int32 sessionId,
                                             String audioCodecNames,
                                             String videoCodecNames,
                                             Boolean existsAudio,
                                             Boolean existsVideo,
        ...
        Int32 onDialogStateUpdated(String BLFMonitoredUri,
         ...
         *  @param existsVideo If it's true, it indicates that this call includes the video.
         */
        Int32 onRemoteUnHold(Int32 sessionId,
                            String audioCodecNames,
                            String videoCodecNames,
                             Boolean existsAudio,
                             Boolean existsVideo);
         ...
         */
        Int32 onReceivedRefer(Int32 sessionId,
                             Int32 referId,
                             String to,
                             String from,
         ...
         */
        Int32 onWaitingVoiceMessage(String messageAccount,
         ...
         *  @param oldMessageCount       Old message count.
         */
        Int32 onWaitingFaxMessage(String messageAccount,
                                                  Int32 urgentNewMessageCount,
                                                  Int32 urgentOldMessageCount,
                                                  Int32 newMessageCount,
                                                  Int32 oldMessageCount);
         ...
         */
        Int32 onRecvNotifyOfSubscription(Int32 subscribeId,
         ...
         */
        Int32 onPresenceRecvSubscribe(Int32 subscribeId,
         ...
         */
        Int32 onPresenceOnline(String fromDisplayName,
                                                    String from,
                                                    String stateText);
         ...
         */
        Int32 onRecvMessage(Int32 sessionId,
                                                 String mimeType,
                                                 String subMimeType,
                                                 byte[] messageData,
         ...
         *  @param messageDataLength The length of "messageData".
         */
        Int32 onRecvOutOfDialogMessage(String fromDisplayName,
                                                 String from,
         ...
         */
        Int32 onSendMessageSuccess(Int32 sessionId,
                                                        Int32 messageId);
         ...
         */
        Int32 onSendMessageFailure(Int32 sessionId,
                                                        Int32 messageId,
                                                        String reason,
                                                        Int32 code);
         ...
         */
        Int32 onSendOutOfDialogMessageSuccess(Int32 messageId,
                                                        String fromDisplayName,
                                                        String from,
                                                        String toDisplayName,
                                                        String to);
         ...
         *  @param code            The failure code.
         */
        Int32 onSendOutOfDialogMessageFailure(Int32 messageId,
                                                        String fromDisplayName,
                                                        String from,
                                                        String toDisplayName,
                                                        String to,
         ...
         */
        Int32 onPlayAudioFileFinished(Int32 sessionId, String fileName);
         ...
         *  @param sessionId The session ID of the call.
         */
        Int32 onPlayVideoFileFinished(Int32 sessionId);
         ...
         */
        Int32 onRTPPacketCallback(IntPtr callbackObject,
                          Int32 sessionId,
                          Int32 mediaType,
                          Int32 direction,
                          byte[] RTPPacket,
        ...
        *  @param dataLength        The data size.
        @note Don't call any SDK API functions in this event directly. If you want to call the API functions or other code which is time-consuming, you should post a message to another thread and execute SDK API functions or other code in another thread.
        */
        Int32 onScreenRawCallback(IntPtr callbackObject,
                                               Int32 sessionId,
                                               Int32 callbackType,
                                               Int32 width,
                                               Int32 height,
