    ...
    public partial class Prueba : Form
    {
        ...
        public async void btnSendMessage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                await rh.SendMessage("Mensage de prueba desde el chat: " + chatId + " con una contPrueba en " + contPrueba, "188", "whatsapp:+5214621257826", "w");
            }
            catch (Exception ex)
            {
        ...
        public void treatNotification(Chat newNotification) 
        {
            try
            {
        ...
        public void buildNewTabChat(Chat chatGenerals)
        {
            try
            {
        ...
        public void buildNewMessagesLabels(Chat chatGenerals)
        {
            try
            {
                chatWindowLocal.chatGenerals = chatGenerals;
